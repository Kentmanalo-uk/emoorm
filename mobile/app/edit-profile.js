...
import { CameraIcon as Camera, TrashIcon as Trash2 } from 'phosphor-react-native';
...
export default function EditProfile() {
  ...
  return <View style={styles.screen}><ScreenHeader title="Edit Profile" /><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
